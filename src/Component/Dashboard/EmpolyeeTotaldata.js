...
const Totalexceldata = () => {
    ...
    const API = `http://localhost:4000/api/excel/exportExcelData/${id}/${JSON.parse(localStorage.getItem("username"))}`;
    ...
    const API2 = `http://localhost:4000/api/excel/searchingdata/${id}/${JSON.parse(localStorage.getItem("username"))}/${searchValue}`;
